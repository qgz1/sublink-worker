...
export const UNIFIED_RULES = [
    ...
    { name: 'Private', outbound: t('outboundNames.Private'), site_rules: ['private'], ip_rules: ['private'] }, // 修复缺失 private
    ...
    { name: 'Gaming', outbound: t('outboundNames.Streaming'), site_rules: ['steam','epicgames','ea','ubisoft','blizzard'], ip_rules: [] },
